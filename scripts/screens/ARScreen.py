...
class ARScreen(Screens):
    ...
    def __init__(self, name=None):
        ...
        self.arbg = pygame.transform.scale(
            pygame.image.load("resources/images/abyssalreefbg.png").convert(),
            (screen_x, screen_y))
    ...
    def get_dead_cats(self):
        ...
        for the_cat in Cat.all_cats_list:
            if the_cat.dead and the_cat.ar and the_cat.ID != game.clan.demon.ID and the_cat.ID != game.clan.instructor.ID \
    ...
    def screen_switches(self):
        ...
        self.abyssal_reef_button = UIImageButton(scale(pygame.Rect((366, 270), (68, 68))), "",
                                                object_id="#abyssal_reef_button"
                                                , manager=MANAGER)
        ...
        self.abyssal_reef_button.disable()
