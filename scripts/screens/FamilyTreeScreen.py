...
class FamilyTreeScreen(Screens):
    ...
    def handle_relation_groups(self):
        ...
        for kitty in display_cats:
            ...
            if game.clan.clan_settings["show fav"] and (not _kitty.faded and _kitty.favourite != 0):
                try:
    ...
    def get_previous_next_cat(self):
        ...
        previous_cat = 0
        next_cat = 0
        if self.the_cat.dead and not is_instructor and not self.the_cat.ar:
        ...
        for check_cat in Cat.all_cats_list:
            if check_cat.ID == self.the_cat.ID:
                ...
                if (
                    ...
                    and check_cat.ar == self.the_cat.ar
