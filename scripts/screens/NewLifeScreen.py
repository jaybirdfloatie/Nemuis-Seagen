...
class NewLifeScreen(Screens):
    ...
    def randomize_custom_cat(self):
        ...
        self.faith = random.choice(["flexible", "starclan", "abyssal reef", "neutral"])
    ...
    # values are ((x position, y position), (x width, y height))
        ...
        #tortie pattern2
            ...
            self.elements['faith'] = pygame_gui.elements.UIDropDownMenu(["flexible", "starclan", "neutral", "abyssal reef"], str(self.faith), scale(pygame.Rect((column3_x, y_pos[2]), (250, 70))), manager=MANAGER)
    ...
    def remove_cat(self, ID):  # ID is cat.ID
        ...
        if ID in game.clan.abyssalreef_cats:
            game.clan.abyssalreef_cats.remove(ID)