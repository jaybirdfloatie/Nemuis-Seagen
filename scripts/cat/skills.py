...
class SkillPath(Enum):
    ...
    ABYSS = (
        "interested in the Abyssal Reef",
        "Abyssal Reef affinity",
        "deep Abyssal Reef bond",
        "unshakable Abyssal Reef link",
    )
...
class CatSkills:
    ...
    influence_flags = {
        ...
        SkillPath.ABYSS: SkillTypeFlag.SUPERNATURAL,
