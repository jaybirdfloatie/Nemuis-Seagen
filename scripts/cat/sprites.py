...
class Sprites:
    ...
    def load_all(self):
        ...
        for x in [
            'lineart', 'lineartar', 'lineartdead', "lineartur",
            'eyes', 'eyes2', 'skin',
            'scars', 'missingscars',
            'medcatherbs', 'wild',
            ...
            'fademask', 'fadestarclan', 'fadeabyssalreef',
            'symbols',
        ...
        self.make_group('lineartar', (0, 0), 'lineartar')
        self.make_group('lineartur', (0, 0), 'lineartur')
        # Fading Fog
        for i in range(0, 3):
            self.make_group('fademask', (i, 0), f'fademask{i}')
            self.make_group('fadestarclan', (i, 0), f'fadestarclan{i}')
            self.make_group('fadeabyssalreef', (i, 0), f'fadear{i}')
        ...
        white_patches = [
            ...
            ['EXTRA', 'ONEEAR', 'BROKEN', 'LIGHTTUXEDO', 'BUZZARarANG', 'RAGDOLL', 'LIGHTSONG', 'VITILIGO', 'BLACKSTAR',
