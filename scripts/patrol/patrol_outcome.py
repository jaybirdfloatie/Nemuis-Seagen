...
class PatrolOutcome:
    ...
    def execute_outcome(self, patrol: "Patrol") -> tuple:
        ...
        results.append(self._handle_ar_convert(patrol))
    ...
    def _handle_ar_convert(self, patrol:'Patrol') -> str:
        """ Handle converting cats to the ar in ar patrols """
        ...
        for _cat in cats_to_convert:
            results.append(f"{_cat.name} has joined the Abyssal Reef.")
            _cat.joined_ar = True
            _cat.faith -= 1
    ...
    def _handle_murder(self, patrol:'Patrol') -> str:
        """ cat killin each other on patrol. just abyssal reef right now"""
    ...
    def __handle_death_history(self, cat: Cat, patrol: "Patrol") -> None:
        ...
        if self.murder:
            ...
            History.add_murders(cat, other_cat, True, f"{other_cat.name} killed this cat in the Abyssal Reef.")
