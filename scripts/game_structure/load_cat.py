...
def json_load():
    ...
    for i, cat in enumerate(cat_data):
        try:
            ...
            new_cat.ar = cat["ar"] if "ar" in cat else False
            ...
            new_cat.joined_ar = cat["joined_ar"] if "joined_ar" in cat else False
            ...
            new_cat.ar_mentor = cat["ar_mentor"] if "ar_mentor" in cat else None
            new_cat.ar_apprentices = cat["ar_apprentices"] if "ar_apprentices" in cat else []
